...
namespace HRM.Infrastructure.Migrations
{
    ...
    [Migration("20230218010424_InterviewModule")]
    partial class InterviewModule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HRM.ApplicationCore.Entity.Interview", b =>
                {
                    ...
                    b.Property<string>("InterviewStatusID")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("InterviewStatusID1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.ApplicationCore.Entity.Interview", b =>
                {
                    b.HasOne("HRM.ApplicationCore.Entity.InterviewStatus", "InterviewStatus")
                        .WithMany()
                        .HasForeignKey("InterviewStatusID1")
